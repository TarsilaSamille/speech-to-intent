...
if __name__ == "__main__":
    ...
    dataset = S2IDataset(
        csv_path="/home/tssdsilveira/corporas/speech-to-intent/train.csv",
    ...
    trainer.fit(model, train_dataloaders=trainloader, val_dataloaders=valloader) #, ckpt_path="checkpoints/hubert-sslepoch=8.ckpt")    
